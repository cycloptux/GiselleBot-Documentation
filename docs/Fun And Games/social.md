...
Shows the server profile (including the EXP status) of a user. By
...
Using the `--roles` parameter will filter the leaderboard to those
...
By default, obtained roles are removed if, and when, a reward of higher
