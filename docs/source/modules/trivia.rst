...
+-------------------------+-----------------------+-----------------------+---------------------------+------------------------------------+-----------------------------------------+-------------------------------------+
| User Type               | Maximum #of Questions | Maximum Time Interval | Can set role restrictions | Can set a different target channel | Can configure auto-deletion of messages | Can configure someone else's trivia |
+=========================+=======================+=======================+===========================+====================================+=========================================+=====================================+
